...
export interface ApiCitaCita extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    fecha_programada: Schema.Attribute.DateTime;
...
export interface ApiFacturaFactura extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estado: Schema.Attribute.Enumeration<['pendiente', 'pagada', 'anulada']>;
    fecha_emision: Schema.Attribute.DateTime;
    ...
    >;
    numeroFactura: Schema.Attribute.UID;
...
export interface ApiHistorialMedicoHistorialMedico
  extends Struct.CollectionTypeSchema {
  collectionName: 'historial_medicos';
  info: {
    displayName: 'Historial_medico';
    pluralName: 'historial-medicos';
    singularName: 'historial-medico';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    enfermedades_cronicas: Schema.Attribute.String;
    fecha_creacion: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::historial-medico.historial-medico'
    > &
      Schema.Attribute.Private;
    mascota: Schema.Attribute.Relation<'oneToOne', 'api::mascota.mascota'>;
    notas_generales: Schema.Attribute.Blocks;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiItemFacturaItemFactura extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Item_factura';
    pluralName: 'item-facturas';
    singularName: 'item-factura';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMascotaMascota extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    esterilizado: Schema.Attribute.Boolean;
    fecha_nacimiento: Schema.Attribute.Date;
    historial_medico: Schema.Attribute.Relation<
      'oneToOne',
      'api::historial-medico.historial-medico'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    rasgo_distintivo: Schema.Attribute.String;
    raza: Schema.Attribute.String;
    sexo: Schema.Attribute.Enumeration<['macho', 'hembra']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiServicioServicio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    citas: Schema.Attribute.Relation<'manyToMany', 'api::cita.cita'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiStockStock extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cantidad_actual: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
